...
<aside>
   <!--uploadImage starts here-->
	...
	<div class="col-md-10 main-section">
		...
		<!--section starts here-->
		<section>
			<h3 style="font-size:16px; font-weight:bold; color:#1C5978; text-align:left;margin-left:0px;">Upload CSV File</h3>
		   ...
		   <!--div starts here-->
			<div>
			   <!--form starts here-->
			   <form id="uploadForm" method="post" action="{{route('upload-csv')}}" enctype="multipart/form-data">
					@csrf   
					<!--table starts here-->
				   <table class="addpage-table">
					   ...
					   <tr>
						   <td></td>
						   <td colspan="2">
							   <button class="srchbtn" type="submit" >Upload</button>    
						   </td>
					   </tr>
				   </table>
				   <!--table ends here-->
